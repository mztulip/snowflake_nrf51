...
GCC_FLAGS="-c -ffunction-sections -fdata-sections -mthumb -mcpu=cortex-m0 -Og -g -mfloat-abi=soft -fmessage-length=0 -fsigned-char -ffreestanding -Wall -Wextra"
GPP_FLAGS="-c -ffunction-sections -fdata-sections -mthumb -mcpu=cortex-m0 -Og -g -mfloat-abi=soft -std=gnu++1y -fno-exceptions -fno-threadsafe-statics -fno-use-cxa-atexit -fno-rtti -fmessage-length=0 -fsigned-char -Wall -Wextra -ffreestanding -fno-builtin -frecord-gcc-switches"
...
filename=Button
file="$TOOLCHAIN_GPP ../../../microhal/microhal/core/button/$filename.cpp $INLCUDES -o build/$filename.o $GPP_FLAGS $GPP_DEFINES"
$file
...
LINER_FLAGS+=" -Og -g -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -ffreestanding -Wall -Wextra --cref"
